      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-start mb-16">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0">
            <img aria-hidden="true" loading='lazy' src="/assets/images/plants-workshop/workshop-care.png" alt={t('about.imageAlt')} className="w-full h-auto rounded-lg shadow-lg" />
          </div>
        </div>
